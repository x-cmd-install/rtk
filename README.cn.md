...
![rtk](https://repo.x-cmd.io/rtk.svg?lang=zh)
...
合计: **115,622** 行代码（覆盖前 5 种语言、共 **259** 个文件）。
...
- **上游仓库**: <https://github.com/rtk-ai/rtk>
- **官网**: <https://www.rtk-ai.app>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `dev-0.50.0-rc.439` (2026-09-11)
- **最近提交**: 2026-09-14
- **Release 含资产**: 10 个

## 流行度

- **Star**: 80,761 · **Fork**: 5,113 · **开放 issue**: 1,632 · **贡献者**: 151

## 累计统计

- **发布数**: 345 · **已合并 PR**: 627 · **开放 PR**: 788 · **已关闭 issue**: 791 · **开放 issue**: 841 · **提交数**: 2032
...
rtk 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `rtk` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/rtk.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260917.yml` · 2026-09-17T05:18:33Z._
